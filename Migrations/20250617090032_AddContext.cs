...
namespace PersonalDoctor.Migrations
{
    /// <inheritdoc />
    public partial class AddContext : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserSpecialty", x => new { x.DoctorsId, x.SpecialtiesId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserSpecialty_AspNetUsers_DoctorsId",
                        column: x => x.DoctorsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserSpecialty_Specialties_SpecialtiesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserSpecialty_SpecialtiesId",
                table: "ApplicationUserSpecialty",
